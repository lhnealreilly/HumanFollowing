...
desired_robot_X = x + (offset_dist * sin(offset_angle + angle));
desired_robot_Y = y + (offset_dist * cos(offset_angle + angle));
...
for i=1:num_steps-1
    ...
    step_limiter = min(1, abs(1/hypot(spring1_x + spring2_x, spring1_y + spring2_y)));
...
legend('Human','Robot Desired', 'Robot Actual')
hold off
